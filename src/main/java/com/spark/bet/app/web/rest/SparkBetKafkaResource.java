...
@RestController
@RequestMapping("/api/spark-bet-kafka")
public class SparkBetKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SparkBetKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SparkBetKafkaResource(KafkaProperties kafkaProperties) {
